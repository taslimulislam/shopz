 ...
 *   https://datatables.net/download/#bs5-5.1.3/dt-1.12.1/b-2.2.3/date-1.1.2
 *
 * Included libraries:
 *   Bootstrap 5 5.1.3, DataTables 1.12.1, Buttons 2.2.3, DateTime 1.1.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5-5.1.3/dt-1.12.1/b-2.2.3/date-1.1.2",
